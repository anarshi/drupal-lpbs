...
function lpbs_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  if (isset($form_id) || $theme === FALSE || !in_array('lpbs', _lpbs_get_base_themes($theme, TRUE))) {
    return;
  }

  // Display a warning if jQuery Update isn't enabled or using a lower version.
  if (!lpbs_setting('toggle_jquery_error', $theme) || !module_exists('jquery_update')) {
  ...
  $form['general']['container']['lpbs_fluid_container'] = array(
    '#type' => 'checkbox',
    '#title' => t('Fluid container'),
    '#default_value' => lpbs_setting('fluid_container', $theme),
  ...
  $form['general']['buttons']['lpbs_button_size'] = array(
    '#type' => 'select',
    '#title' => t('Default button size'),
    '#default_value' => lpbs_setting('button_size', $theme),
  ...
  $form['general']['buttons']['lpbs_button_colorize'] = array(
    '#type' => 'checkbox',
    '#title' => t('Colorize Buttons'),
    '#default_value' => lpbs_setting('button_colorize', $theme),
    '#description' => t('Adds classes to buttons based on their text value. See: <a href="!lpbs_url" target="_blank">Buttons</a> and <a href="!api_url" target="_blank">hook_lpbs_colorize_text_alter()</a>', array(
      '!lpbs_url' => 'http://getbootstrap.com/css/#buttons',
      '!api_url' => 'http://drupal-bootstrap.org/apis/hook_lpbs_colorize_text_alter',
    )),
  );
  $form['general']['buttons']['lpbs_button_iconize'] = array(
    '#type' => 'checkbox',
    '#title' => t('Iconize Buttons'),
    '#default_value' => lpbs_setting('button_iconize', $theme),
    '#description' => t('Adds icons to buttons based on the text value. See: <a href="!api_url" target="_blank">hook_lpbs_iconize_text_alter()</a>', array(
      '!api_url' => 'http://drupal-bootstrap.org/apis/hook_lpbs_iconize_text_alter',
    )),
  );
  ...
  $form['general']['forms']['lpbs_forms_required_has_error'] = array(
    '#type' => 'checkbox',
    '#title' => t('Make required elements display as an error'),
    '#default_value' => lpbs_setting('forms_required_has_error', $theme),
  ...
  $form['general']['forms']['lpbs_forms_smart_descriptions'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => lpbs_setting('forms_smart_descriptions', $theme),
  );
  $form['general']['forms']['lpbs_forms_smart_descriptions_limit'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => lpbs_setting('forms_smart_descriptions_limit', $theme),
    '#states' => array(
      'visible' => array(
        ':input[name="lpbs_forms_smart_descriptions"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['general']['forms']['lpbs_forms_smart_descriptions_allowed_tags'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => lpbs_setting('forms_smart_descriptions_allowed_tags', $theme),
    '#states' => array(
      'visible' => array(
        ':input[name="lpbs_forms_smart_descriptions"]' => array('checked' => TRUE),
      ),
  ...
  $form['general']['images']['lpbs_image_shape'] = array(
    '#type' => 'select',
    '#title' => t('Default image shape'),
    '#description' => t('Add classes to an <code>&lt;img&gt;</code> element to easily style images in any project. Note: Internet Explorer 8 lacks support for rounded corners. See: <a href="!lpbs_url" target="_blank">Image Shapes</a>', array(
      '!lpbs_url' => 'http://getbootstrap.com/css/#images-shapes',
    )),
    '#default_value' => lpbs_setting('image_shape', $theme),
    '#empty_option' => t('None'),
    '#options' => array(
  ...
  $form['general']['images']['lpbs_image_responsive'] = array(
    '#type' => 'checkbox',
  ...
  $form['general']['tables']['lpbs_table_bordered'] = array(
    '#type' => 'checkbox',
    '#title' => t('Bordered table'),
    '#default_value' => lpbs_setting('table_bordered', $theme),
    '#description' => t('Add borders on all sides of the table and cells.'),
  );
  $form['general']['tables']['lpbs_table_condensed'] = array(
    '#type' => 'checkbox',
    '#title' => t('Condensed table'),
    '#default_value' => lpbs_setting('table_condensed', $theme),
    '#description' => t('Make tables more compact by cutting cell padding in half.'),
  );
  $form['general']['tables']['lpbs_table_hover'] = array(
    '#type' => 'checkbox',
    '#title' => t('Hover rows'),
    '#default_value' => lpbs_setting('table_hover', $theme),
    '#description' => t('Enable a hover state on table rows.'),
  );
  $form['general']['tables']['lpbs_table_striped'] = array(
    '#type' => 'checkbox',
    '#title' => t('Striped rows'),
    '#default_value' => lpbs_setting('table_striped', $theme),
  ...
  $form['general']['tables']['lpbs_table_responsive'] = array(
    '#type' => 'checkbox',
    '#title' => t('Responsive tables'),
    '#default_value' => lpbs_setting('table_responsive', $theme),
  ...
  if (_lpbs_use_path_breadcrumbs($theme)) {
    ...
    $form['components']['breadcrumbs']['lpbs_breadcrumb'] = array(
      '#type' => 'select',
      '#title' => t('Breadcrumb visibility'),
      '#default_value' => lpbs_setting('breadcrumb', $theme),
      '#options' => array(
        0 => t('Hidden'),
        1 => t('Visible'),
    ...
    $form['components']['breadcrumbs']['lpbs_breadcrumb_home'] = array(
      '#type' => 'checkbox',
      '#title' => t('Show "Home" breadcrumb link'),
      '#default_value' => lpbs_setting('breadcrumb_home', $theme),
      '#description' => t('If your site has a module dedicated to handling breadcrumbs already, ensure this setting is enabled.'),
      '#states' => array(
        'invisible' => array(
          ':input[name="lpbs_breadcrumb"]' => array('value' => 0),
        ),
      ),
    );
    $form['components']['breadcrumbs']['lpbs_breadcrumb_title'] = array(
      '#type' => 'checkbox',
      '#title' => t('Show current page title at end'),
      '#default_value' => lpbs_setting('breadcrumb_title', $theme),
  ...
  $form['components']['navbar']['lpbs_navbar_position'] = array(
    '#type' => 'select',
    '#title' => t('Navbar Position'),
    '#description' => t('Select your Navbar position.'),
    '#default_value' => lpbs_setting('navbar_position', $theme),
    '#options' => array(
  ...
  $form['components']['navbar']['lpbs_navbar_inverse'] = array(
    '#type' => 'checkbox',
    '#title' => t('Inverse navbar style'),
    '#description' => t('Select if you want the inverse navbar style.'),
    '#default_value' => lpbs_setting('navbar_inverse', $theme),
  );
  ...
  $form['components']['pager']['lpbs_pager_first_and_last'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => lpbs_setting('pager_first_and_last', $theme),
  );
  ...
  foreach ($regions as $name => $title) {
    $form['components']['region_wells']['lpbs_region_well-' . $name] = array(
      '#title' => $title,
      '#type' => 'select',
      '#attributes' => array(
      ...
      '#options' => $wells,
      '#default_value' => lpbs_setting('region_well-' . $name, $theme),
    );
  }
  ...
  $form['javascript']['anchors']['lpbs_anchors_fix'] = array(
    '#type' => 'checkbox',
    '#title' => t('Fix anchor positions'),
    '#default_value' => lpbs_setting('anchors_fix', $theme),
  ...
  $form['javascript']['anchors']['lpbs_anchors_smooth_scrolling'] = array(
    '#type' => 'checkbox',
    '#title' => t('Enable smooth scrolling'),
    '#default_value' => lpbs_setting('anchors_smooth_scrolling', $theme),
    '#description' => t('Animates page by scrolling to an anchor link target smoothly when clicked.'),
    '#states' => array(
      'invisible' => array(
        ':input[name="lpbs_anchors_fix"]' => array('checked' => FALSE),
      ),
    ),
    // Prevent UI edits, see description above.
    '#disabled' => TRUE,
  ...
  $form['javascript']['forms']['lpbs_forms_has_error_value_toggle'] = array(
    '#type' => 'checkbox',
    '#title' => t('Automatically remove error classes when values have been entered'),
    '#default_value' => lpbs_setting('forms_has_error_value_toggle', $theme),
  ...
  $form['javascript']['popovers']['lpbs_popover_enabled'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => lpbs_setting('popover_enabled', $theme),
  );
  $form['javascript']['popovers']['options'] = array(
    ...
    '#states' => array(
      'visible' => array(
        ':input[name="lpbs_popover_enabled"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['javascript']['popovers']['options']['lpbs_popover_animation'] = array(
    '#type' => 'checkbox',
    '#title' => t('animate'),
    '#description' => t('Apply a CSS fade transition to the popover.'),
    '#default_value' => lpbs_setting('popover_animation', $theme),
  );
  $form['javascript']['popovers']['options']['lpbs_popover_html'] = array(
    '#type' => 'checkbox',
    '#title' => t('HTML'),
    ...
    '#default_value' => lpbs_setting('popover_html', $theme),
  );
  $form['javascript']['popovers']['options']['lpbs_popover_placement'] = array(
    '#type' => 'select',
    '#title' => t('placement'),
    ...
    '#default_value' => lpbs_setting('popover_placement', $theme),
  ...
  $form['javascript']['popovers']['options']['lpbs_popover_selector'] = array(
    '#type' => 'textfield',
    '#title' => t('selector'),
    ...
    '#default_value' => lpbs_setting('popover_selector', $theme),
  );
  $form['javascript']['popovers']['options']['lpbs_popover_trigger'] = array(
    '#type' => 'checkboxes',
    '#title' => t('trigger'),
    '#description' => t('How a popover is triggered.'),
    '#default_value' => lpbs_setting('popover_trigger', $theme),
    '#options' => drupal_map_assoc(array(
      'click',
      'hover',
      'focus',
  ...
  $form['javascript']['popovers']['options']['lpbs_popover_trigger_autoclose'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => lpbs_setting('popover_trigger_autoclose', $theme),
  );
  $form['javascript']['popovers']['options']['lpbs_popover_title'] = array(
    '#type' => 'textfield',
    '#title' => t('title'),
    '#description' => t("Default title value if \"title\" attribute isn't present."),
    '#default_value' => lpbs_setting('popover_title', $theme),
  );
  $form['javascript']['popovers']['options']['lpbs_popover_content'] = array(
    '#type' => 'textfield',
    '#title' => t('content'),
    '#description' => t('Default content value if "data-content" or "data-target" attributes are not present.'),
    '#default_value' => lpbs_setting('popover_content', $theme),
  );
  $form['javascript']['popovers']['options']['lpbs_popover_delay'] = array(
    '#type' => 'textfield',
    '#title' => t('delay'),
    ...
    '#default_value' => lpbs_setting('popover_delay', $theme),
  );
  $form['javascript']['popovers']['options']['lpbs_popover_container'] = array(
    '#type' => 'textfield',
    '#title' => t('container'),
    ...
    '#default_value' => lpbs_setting('popover_container', $theme),
  );
  ...
  $form['javascript']['tooltips']['lpbs_tooltip_enabled'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => lpbs_setting('tooltip_enabled', $theme),
  );
  $form['javascript']['tooltips']['options'] = array(
    ...
    '#states' => array(
      'visible' => array(
        ':input[name="lpbs_tooltip_enabled"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['javascript']['tooltips']['options']['lpbs_tooltip_animation'] = array(
    '#type' => 'checkbox',
    '#title' => t('animate'),
    '#description' => t('Apply a CSS fade transition to the tooltip.'),
    '#default_value' => lpbs_setting('tooltip_animation', $theme),
  );
  $form['javascript']['tooltips']['options']['lpbs_tooltip_html'] = array(
    '#type' => 'checkbox',
    '#title' => t('HTML'),
    ...
    '#default_value' => lpbs_setting('tooltip_html', $theme),
  );
  $form['javascript']['tooltips']['options']['lpbs_tooltip_placement'] = array(
    '#type' => 'select',
    '#title' => t('placement'),
    ...
    '#default_value' => lpbs_setting('tooltip_placement', $theme),
    '#options' => drupal_map_assoc(array(
      'top',
      'bottom',
      'left',
  ...
  $form['javascript']['tooltips']['options']['lpbs_tooltip_selector'] = array(
    '#type' => 'textfield',
    '#title' => t('selector'),
    '#description' => t('If a selector is provided, tooltip objects will be delegated to the specified targets.'),
    '#default_value' => lpbs_setting('tooltip_selector', $theme),
  );
  $form['javascript']['tooltips']['options']['lpbs_tooltip_trigger'] = array(
    '#type' => 'checkboxes',
    '#title' => t('trigger'),
    '#description' => t('How a tooltip is triggered.'),
    '#default_value' => lpbs_setting('tooltip_trigger', $theme),
    '#options' => drupal_map_assoc(array(
      'click',
      'hover',
      'focus',
  ...
  $form['javascript']['tooltips']['options']['lpbs_tooltip_delay'] = array(
    '#type' => 'textfield',
    '#title' => t('delay'),
    ...
    '#default_value' => lpbs_setting('tooltip_delay', $theme),
  );
  $form['javascript']['tooltips']['options']['lpbs_tooltip_container'] = array(
    '#type' => 'textfield',
    '#title' => t('container'),
    '#description' => t('Appends the tooltip to a specific element. Example: "body"'),
    '#default_value' => lpbs_setting('tooltip_container', $theme),
  );
  ...
  $form['advanced']['lpbs_toggle_jquery_error'] = array(
    '#type' => 'checkbox',
    '#title' => t('Suppress jQuery version error message'),
    '#default_value' => lpbs_setting('toggle_jquery_error', $theme),
  ...
  // BootstrapCDN.
  lpbs_cdn_provider_settings_form($form, $form_state, $theme);
}
