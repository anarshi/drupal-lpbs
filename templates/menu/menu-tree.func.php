...
/**
 * @file
 * Stub file for lpbs_menu_tree() and suggestion(s).
 */
 ...
 */
function lpbs_menu_tree(&$variables) {
 ...
 */
function lpbs_menu_tree__primary(&$variables) {
 ...
 */
function lpbs_menu_tree__book_toc(&$variables) {
 ...
 * Overrides theme_menu_tree() for book module.
 */
function lpbs_menu_tree__book_toc__sub_menu(&$variables) {
